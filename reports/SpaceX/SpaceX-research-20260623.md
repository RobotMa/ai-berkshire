> # ⚠️ 本报告已作废（2026-07-10）
>
> **请勿引用本报告的价格、市值与估值倍数。** 已被 [`SpaceX-research-20260710.md`](./SpaceX-research-20260710.md) 取代。
>
> **作废原因：**
>
> | 项目 | 本报告 | 实际（2026-07-10） | 说明 |
> |---|---|---|---|
> | 股价 | $165.78 | **$145.30** | 偏差 14.1% |
> | 市值 | $2.17 万亿 | **$1.91 万亿** | 偏差 13.6% |
> | 2024 ARPU | $81/月 | **$91/月**（口径存疑） | 与同目录 IPO 拆解文一文一表，两份报告自相矛盾，均未经 424B4 核实 |
>
> 本报告成稿于上市后第 11 天，价格数据为当时快照；SPCX 自 6/16 高点 $225.64 已回撤约 36%，价格类结论全部失效。
>
> **仍然有效的部分**：分部收入结构、股权与治理结构的定性描述。但**建议一律以 20260710 版为准**——该版基于 SEC 424B4 一手数据，并通过 stockanalysis 交叉核验（10 个核心财务点，7 个零偏差，其余 ≤0.36%）。
>
> ---
